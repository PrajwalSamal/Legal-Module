		...
		while (rs.next()) {
			...
			if (null == currentProperty) {
				...
				currentProperty = Property.builder()
						.source(org.egov.lm.models.enums.Source.fromValue(rs.getString("source")))
