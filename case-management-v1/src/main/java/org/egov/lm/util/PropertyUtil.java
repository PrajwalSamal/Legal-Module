...
import static org.egov.lm.util.PTConstants.BILL_AMOUNT_PATH;
import static org.egov.lm.util.PTConstants.BILL_NODEMAND_ERROR_CODE;
...
public class PropertyUtil extends CommonUtils {
	 ...
	 * @return
	 */
	private org.egov.lm.models.user.User getMaskedOwnerInfo(OwnerInfo info) {
