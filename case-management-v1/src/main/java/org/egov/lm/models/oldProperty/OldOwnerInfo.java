package org.egov.lm.models.oldProperty;
...
@NoArgsConstructor
@ToString
public class OldOwnerInfo extends User  {
        ...
        public OldOwnerInfo addDocumentsItem(OldDocument documentsItem) {
                if (this.oldDocuments == null) {
                        this.oldDocuments = new HashSet<>();
                }
                this.oldDocuments.add(documentsItem);
                return this;
        }
